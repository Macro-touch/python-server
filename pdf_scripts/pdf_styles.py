...
PRIMARY_GOV_HEADING = Paragraph(
    "RECEIPT OF GOVERNMENT GRANT & LIST OF TDS", header_style
)
...
TABLE_TITLE = {
    ...
    "GRANT": Paragraph(
        "RECEPIT OF GOVERNMENT GRANT", getSampleStyleSheet()["Heading1"]
    ),
    ...
    "INTEREST": Paragraph(
        "INTEREST CREDITED AND DEBITED", getSampleStyleSheet()["Heading1"]
    ),
}
